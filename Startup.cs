...
namespace FinaleProject
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<DataBContext>(x => x.UseSqlServer(Configuration.GetConnectionString("Connection")));
            services.Configure<CloudinaryConnection>(Configuration.GetSection("CloudinaryConnection"));
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "FinaleProject", Version = "v1" });
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "FinaleProject v1"));
            }
